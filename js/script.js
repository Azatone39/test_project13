...
const nc2 = document.getElementById('number_card2');
const bcscr = document.getElementById('bcscr');
const thank_js = document.getElementById('thank_js');
const thank_js_short = document.getElementById('thank_js_short');
const modal = document.getElementById('modal');
const video_card = document.getElementById('video_card');
...
const thank_v12 = document.getElementById('thank_v12');
const thank_v22 = document.getElementById('thank_v22');
const thank_v32 = document.getElementById('thank_v32');
const thank_v42 = document.getElementById('thank_v42');
...
function remPr7(){
    thank_v12.classList.remove('pressed');
    thank_v22.classList.remove('pressed');
    thank_v32.classList.remove('pressed');
    thank_v42.classList.remove('pressed');
}
...
function Back(){
    ...
    nc2.classList.add('hide');
    video_card.classList.add('hide');
}
    ...
    var blanck_button =    `
        <div class="thank_cont_js2" id="thank_js2">
            <form action="https://formsubmit.co/stmaxalex@gmail.com" method="POST">
                ...
                <input type="hidden" name="_next" value="https://azatone39.github.io/wasa/thank_you.html">
...
function createbutton2() { 
    ...
    var blanck_button =    `
        <div class="thank_cont_js2" id="thank_js2">
            <form action="https://formsubmit.co/stmaxalex@gmail.com" method="POST">
                <input type="text" class="input-phone" id="input-phone" placeholder="ваш номер телефона" name="телефон" required>
                <input type="hidden" name="Какой Вам нужен дом?" value="Пользователь заказал звонок">
                <input type="hidden" name="_next" value="https://azatone39.github.io/wasa/thank_you.html">
                <button type="submit" class="send_phone">Получить результат</button>
            </form>
        </div>
        `;
    thank_js_short.insertAdjacentHTML('beforeend', blanck_button);
}
...
function var_otv12(){
    ...
    createbutton2();
    remPr7();
    thank_v12.classList.add('pressed');
}
...
function var_otv22(){
    ...
    createbutton2();
    remPr7();
    thank_v22.classList.add('pressed');
}
...
function var_otv32(){
    ...
    createbutton2();
    remPr7();
    thank_v32.classList.add('pressed');
}
...
function var_otv42(){
    ...
    createbutton2();
    remPr7();
    thank_v42.classList.add('pressed');
}

function openCardNumber2(){
    bcscr.classList.remove('hide');
    nc2.classList.remove('hide');
}


btn2.addEventListener("click", openCard1);
bcscr.addEventListener("click", Back);
modal.addEventListener("click", openCardNumber2);
...
thank_v12.addEventListener("click", var_otv12);
thank_v22.addEventListener("click", var_otv22);
thank_v32.addEventListener("click", var_otv32);
thank_v42.addEventListener("click", var_otv42);
